...
def pairs(formatted_corpus):

    pair_dict = {}
    for sentences in formatted_corpus:
        for line in sentences:
            if line['deprel'] == 'SS':
                head = sentences[int(line['head'])]
                pair = (line['form'], head['form'])
...
if __name__ == '__main__':
    ...
    #pairs(formatted_corpus)
    triples(formatted_corpus)
